  ...
  return (
    <CamNangLayout title={title}>
      ...
      <p>
        ...
        sắc đều có một tầng ý nghĩa riêng, được chọn lọc kỹ lưỡng để vừa hợp phong tục vừa truyền
        tải được thông điệp tâm linh.
      </p>
      <p>
      ...
      <h3>Hoa cúc trắng</h3>
      <p>
        Hoa cúc trắng là loài hoa xuất hiện phổ biến nhất trong các tang lễ của người Việt. Cúc
        trắng gắn liền với hình ảnh thanh cao, thuần khiết và bền bỉ, được xem là biểu tượng của sự
        vĩnh hằng. Khi đặt trên bàn thờ tang lễ, hoa cúc trắng như một lời cầu nguyện bình an cho
        người đã khuất, đồng thời xoa dịu nỗi đau mất mát của người còn sống.
      </p>
      <p>
      ...
      <h3>Hoa ly</h3>
      <p>
        Hoa ly, đặc biệt là hoa ly trắng, mang thông điệp về sự thanh khiết và cao quý. Trong văn
        hóa phương Đông, hoa ly được xem là biểu tượng của sự tiễn biệt nhẹ nhàng, thanh thản. Người
        ta tin rằng khi dâng hoa ly lên bàn thờ, linh hồn người đã khuất sẽ cảm nhận được sự thanh
        thoát, an yên trong hành trình sang thế giới bên kia.
      </p>
      <p>
      ...
      <h3>Hoa lan trắng</h3>
      <p>
        Hoa lan trắng mang trong mình vẻ đẹp thanh thoát, biểu trưng cho tình yêu vĩnh cửu và sự
        tưởng nhớ sâu sắc. Trong nhiều đám tang hiện đại, lan trắng thường được phối hợp với hoa cúc
        và hoa ly để tạo nên sự mềm mại, trang nhã. Đây cũng là loài hoa thể hiện sự sang trọng,
        được nhiều gia đình lựa chọn cho các tang lễ lớn.
      </p>
      <p>
        Về mặt thẩm mỹ, hoa lan có hình dáng độc đáo, dễ dàng phối hợp trong nhiều kiểu cắm khác
        nhau. Ý nghĩa sâu xa của hoa lan trắng còn nằm ở sự tưởng niệm dài lâu – một thông điệp rằng
        tình thương và sự gắn bó vẫn tồn tại ngay cả khi người thân đã rời xa.
      </p>

      <h3>Các loại khác</h3>
      <p>
        Ngoài những loài hoa chính kể trên, một số gia đình còn sử dụng hoa hồng trắng, hoa đồng
        tiền trắng hoặc hoa sen. Hoa hồng trắng thể hiện sự thuần khiết, đồng tiền trắng mang đến sự
        bình an, còn hoa sen – đặc biệt trong bối cảnh Phật giáo – biểu trưng cho sự giác ngộ và
        giải thoát. Tùy vào phong tục địa phương và tôn giáo, gia đình có thể linh hoạt lựa chọn sao
        cho phù hợp.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>Số lượng:</strong> Chọn số lượng hoa vừa đủ, cân đối hai bên bàn thờ. Không nên
          cắm quá nhiều gây rườm rà.
        </li>
        <li>
      ...
      <p>
        Để không gian thờ cúng thêm hài hòa, gia đình có thể tham khảo một số cách phối hợp phổ
        biến:
      </p>
      <ol>
        <li>
        ...
        <li>
          <strong>Đặt vị trí:</strong> Bình hoa lớn chính giữa bàn thờ hoặc đặt cân đối hai bên.
          Vòng hoa tưởng niệm đặt ngoài, không đặt trực tiếp lên bàn thờ.
        </li>
      </ol>
      ...
      <p>
        Nếu gia đình cần được hỗ trợ trong việc chuẩn bị tang lễ, từ chọn hoa, bài trí bàn thờ đến
        tổ chức toàn bộ nghi thức, hãy liên hệ ngay với{' '}
        <a
