...
export default function Article() {
  return (
    <CamNangLayout title={title}>
      ...
      <p>
        Ngoài ra, Tết Đoan Ngọ còn là dịp con cháu bày tỏ lòng hiếu kính với tổ tiên và cầu mong mùa
        màng bội thu.
      </p>
      ...
      <h3>Cúng tổ tiên</h3>
      <p>
        Vào sáng mùng 5 tháng 5, gia đình chuẩn bị mâm cỗ cúng tổ tiên với rượu nếp, bánh tro, trái
        cây theo mùa và các món ăn truyền thống. Sau lễ cúng, con cháu sẽ cùng nhau thụ lộc.
      </p>
      <h3>Tục diệt sâu bọ</h3>
      <p>
        Người dân tin rằng ăn rượu nếp, trái cây chua ngọt sáng sớm sẽ giúp diệt ký sinh, bảo vệ sức
        khỏe. Đây là phong tục đặc trưng nhất của Tết Đoan Ngọ.
      </p>
      <h3>Tắm lá mùi, xông nhà</h3>
      <p>
        Một số vùng quê còn giữ tục tắm lá mùi, xông nhà bằng thảo dược để trừ tà, mang lại may mắn
        và sức khỏe.
      </p>
      ...
      <h3>Rượu nếp cái</h3>
      <p>
        Rượu nếp cái là món không thể thiếu, tượng trưng cho việc diệt sâu bọ. Làm từ gạo nếp cái
        hoa vàng, lên men tự nhiên, có vị cay nồng và thơm dịu.
      </p>
      ...
      <p>
        Mận, vải, xoài, dưa hấu… ăn để diệt trừ ký sinh, bảo vệ sức khỏe và mang lại sự thanh khiết.
      </p>
      <h3>Các món dân gian khác</h3>
      <p>
        Miền Bắc: cơm rượu nếp; Miền Trung: chè kê, bánh ít lá gai; Miền Nam: chè trôi nước, cơm
        rượu, trái cây miệt vườn.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>Miền Nam:</strong> Mâm cúng phong phú: chè trôi nước, cơm rượu, trái cây miệt
          vườn.
        </li>
      </ul>
